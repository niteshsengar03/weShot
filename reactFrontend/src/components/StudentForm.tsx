    ...
    <div className="student-form-container">
      <div className="form-wrapper">
        <div className="form-header">
          <h1 className="form-title">We <span className="highlight">Shot</span></h1>
          ...
          <div className="info-section">
            ...
            <div className="info-content">
              <p>
                Our mission is to keep you updated on <strong>VIT Chennai placements</strong>. 
                If you get shortlisted in a company, we will email you the details.
              </p>
              <p>
                Please provide an email address that you <strong>check regularly</strong> and 
                that <strong>does not receive too many emails daily</strong> so you never miss our alerts.
              </p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="student-form">
          ...
          <div className="input-group">
            <input
              ...
              required
            />
            <label htmlFor="regNo" className={formData.regNo ? 'active' : ''}>Registration No.</label>
